...
public class DynamicListView extends ListView {
     ...
     */
    public void enableSwipeToDismiss(final boolean enableRightSwipe, @NonNull final OnDismissCallback onDismissCallback) {
        mSwipeTouchListener = new SwipeDismissTouchListener(enableRightSwipe, new DynamicListViewWrapper(this), onDismissCallback);
    }
