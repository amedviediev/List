...
public abstract class SwipeTouchListener implements View.OnTouchListener, TouchEventHandler {
    ...
    /**
     * Indicates direction of swipe
     */
    protected boolean swipingRight = false;

    /**
     * Indicates if right swipe should be animated
     */
    protected boolean enableRightSwipe;

    /**
     * Constructs a new {@code SwipeTouchListener} for the given {@link android.widget.AbsListView}.
     */
    @SuppressWarnings("UnnecessaryFullyQualifiedName")
    protected SwipeTouchListener(final boolean enableRightSwipe, @NonNull final ListViewWrapper listViewWrapper) {
    ...
    private boolean handleMoveEvent(@Nullable final View view, @NonNull final MotionEvent motionEvent) {
        ...
        if (mSwiping) {
            if (mCanDismissCurrent) {
                ...
                if(swipingRight && enableRightSwipe){
                    mSwipingView.setBackgroundColor(Color.GREEN);
                } else mSwipingView.setBackgroundColor(Color.RED);
            } else {
    ...
    private void restoreCurrentViewTranslation() {
        ...
        mSwipingView.setBackgroundColor(android.R.drawable.btn_default);
    ...
    protected void restoreViewPresentation(@NonNull final View view) {
        ...
        swipedView.setBackgroundColor(android.R.drawable.btn_default);
    }
