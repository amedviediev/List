...
public class SimpleSwipeUndoAdapter extends SwipeUndoAdapter implements UndoCallback {
    ...
    @Override
    public void onDismiss(@NonNull final ViewGroup listView, @NonNull final int[] reverseSortedPositions, @NonNull final boolean toTheRight) {
        mOnDismissCallback.onDismiss(listView, reverseSortedPositions, toTheRight);
